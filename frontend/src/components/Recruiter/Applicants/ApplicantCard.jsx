...
export default function ApplicantCard() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 max-w-xs h-72 flex flex-col">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div>
          ...
          <p className="text-base text-gray-800">{applicant.specialization}</p>
        </div>
      </div>
