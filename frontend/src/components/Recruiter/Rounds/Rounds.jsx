...
function Rounds() {
  ...
  const handleIconClick = () => {
    setClickCount((prevCount) => {
      ...
      if (newCount === 3) {
        alert("Publish Placement Results?");
        return 0; // Reset count after alert
      }
      return newCount;
    });
  };
  ...
  return (
    <div className="space-y-6 px-4 py-6">
      ...
      {showForm && <RoundForm onCancel={() => setShowForm(false)} />}
            ...
            <div key={round.id} className="bg-white shadow rounded-lg p-6 mb-4">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Order Number: {round.order_number}
                  </p>
                  <p className="text-sm text-gray-500">
                    Job ID: {round.job_id}
                  </p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {round.status !== "Completed" && (
                    ...
                    >
                      <FaCheck onClick={handleIconClick} className="h-4 w-4" />
                    </button>
                  )}
                </div>
              </div>
