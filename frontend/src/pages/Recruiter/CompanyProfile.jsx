        ...
        <div className="flex-1 max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center justify-center mt-16">
            ...
            <img
              ...
              onClick={() =>
                isEditing && document.getElementById("companyLogo").click()
          ...
          <div className="border border-gray-300 shadow-lg rounded-lg p-6 mt-12 transition-all hover:shadow-2xl hover:scale-105 hover:bg-blue-50">
            ...
            {isEditing ? (
              ...
              <p className="mt-3 text-lg text-gray-700">
                Internspirit is a dynamic platform that provides job
                opportunities, career growth, and networking for professionals
                worldwide. Our platform connects talented individuals with
                leading companies across various industries, fostering career
                advancement and development. Whether you're looking for your
                next job, internship, or partnership, Internspirit helps you
                achieve your goals.
              </p>
            )}
          </div>
